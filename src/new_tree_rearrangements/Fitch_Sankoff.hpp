...
void Fitch_Sankoff_Whole_Tree(const std::vector<Mutation_Annotated_Tree::Node*> bfs_ordered_nodes,const Mutation_Annotated_Tree::Mutation & base,const std::unordered_map<std::string, nuc_one_hot>& mutated,std::vector<tbb::concurrent_vector<Mutation_Annotated_Tree::Mutation>>& output);
