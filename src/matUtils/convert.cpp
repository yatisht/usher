...
json get_json_entry(MAT::Node* n) {
...
void write_json_from_mat(MAT::Tree* T, std::string output_filename) {
    ...
    std::map<std::string,std::string> lm = {{"branch_label", "nuc mutations"}};
    nj = {
        {"version","v2"},
        {"meta", {
            {"title","mutation_annotated_tree"},
    ...
    //nj = json::parse("{\"version\":\"v2\",\"meta\":{\"title\":\"mutation_annotated_tree\",\"filters\": [\"country\"],\"panels\": [\"tree\"],\"colorings\": [ {\"key\":\"MAT_Clade_0\",\"title\":\"MAT_Clade\",\"type\":\"categorical\"}, {\"key\":\"MAT_Clade_1\",\"title\":\"MAT_Clade\",\"type\":\"categorical\"} ],\"display_defaults\":{\"branch_label\":\"nuc mutations\"},\"description\":\"JSON generated by matUtils. If you have metadata you wish to display, you can now drag on a CSV/TSV file and it will be added into this view, [see here](https://docs.nextstrain.org/projects/auspice/en/latest/advanced-functionality/drag-drop-csv-tsv.html) for more info.\"}");
