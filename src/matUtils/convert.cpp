...
void write_json_from_mat(MAT::Tree* T, std::string output_filename) {
    ...
    nj = {
        ...
        {"meta", {
            ...
            {"colorings",json::array({{"key","MAT_Clade_0"},{"title","MAT_Clade"},{"type","categorical"}})},
            {"display_defaults",json::array({{"branch_label","muc mutations"},{"description","JSON generated by matUtils. If you have metadata you wish to display, you can now drag on a CSV/TSV file and it will be added into this view, [see here](https://docs.nextstrain.org/projects/auspice/en/latest/advanced-functionality/drag-drop-csv-tsv.html) for more info."}})}
        }},
        {"tree",{
            {"name","wrapper"},
        }}
