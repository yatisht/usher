...
build/usher -i $1 -v $2 -o testout/not-refined.pb
mkfifo testout/refined.vcf
mkfifo testout/not-refined.vcf
build/matUtils convert -i testout/refined.pb -v testout/refined.vcf&
perl vcfNormalizeGt.pl testout/refined.vcf >testout/refined.normalized.vcf
build/matUtils convert -i testout/not-refined.pb -v testout/not-refined.vcf&
